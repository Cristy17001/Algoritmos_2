 ...
 * @code - the airport of origin
 * @neighbors - unordered_map capable of storing the destination airport and the possible airlines to achieve it, and insertion of them in O(1) time complexity
 * @n_visited - auxiliary counter for the design of the BFS
 *
 * @see FlightGraph
 */
struct Node {
